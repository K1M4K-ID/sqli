...
${G}__██____██___
   ...
   ${N}|${B}\033[7m SQLi bypass SQL login auto xploiter ${N}|
"
}
menu() {
banner
...
banner5() {
   ...
   ${G}    .---.        .----------- ${N}
  ${G}    /     \  __  /    ------ ${N}
   ${G}  / /     \(  )/    -----  ${N}   \033[7;36m SQLi Vip MOD ${N}\033[1;36m\033[1m FINAL${N}
  ${G}  //////   ' \/ \`   ---   ${N}    \033[2m |==┣▇▇▇▇▇▇▇▇═─-SQl-i ${N}
...
banner4() {
  echo -e " 
                    \033[7;31m SQLi Vip MOD ${N}${R} FINAL${N}
                          /
...
banner2() {
echo -e "                    \033[7;31m SQLi Vip MOD ${N}${R} FINAL${N}${G}"
cat << "EOF"
                        /
       　　　/)        /  
